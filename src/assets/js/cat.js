 ...
 * @LastEditTime: 2021-12-11 01:43:10
 * @FilePath: /sku-blog-vite/src/assets/js/cat.js
 */
export default function (opts) {
  ...
  // Opt.scrollWrapper || $content!.parentNode || document.body
  ...
  // 绿色 #42B983 橙色 #f8ba0b
  try {
    $catalog.innerHTML = `<div class='cl-wrapper'>${generateHtmlTree(tree, { id: -1 })}<svg class="cl-marker" 
            width="200" height="200" xmlns="http://www.w3.org/2000/svg">
            <path stroke="#42B983" stroke-width="3" fill="transparent" 
            stroke-dasharray="0, 0, 0, 1000" stroke-linecap="round" stroke-linejoin="round" 
  ...
  return desEvent = () => {
    ...
    window.removeEventListener('scroll', coolScrollHandler, true)
    window.removeEventListener('scroll', simpleScrollHandler, true)
  }
}
